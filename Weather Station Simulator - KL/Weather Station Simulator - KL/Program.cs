namespace Weather_Station_Simulator___KL
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Max temperature was {maxTemperature}.");
            Console.WriteLine($"Min temperature was {minTemperature}.");
            Console.WriteLine($"Most common condition is {mostCommonCondition}.");
